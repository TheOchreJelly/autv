# PWH: added some more simple options for the dialog command
# to allow them to be used as keyword arguments
# otherwise there is no way to unset the value after setting with add_persistent_args
# (minor design flaw!):
#   --ascii-lines
#   --colors
#   --extra-button
...
#   --visit-items
#
# also added the following for convenience:
#   --cancel-label string
...
_common_args_syntax = {
    ...
    "column_separator": lambda string: ("--column-separator", string),
    ...
    "keep_title": lambda enable: _simple_option("--keep-title", enable),
    ...
    "nook": lambda enable: _simple_option("--nook", enable),
    ...
    "output_separator": lambda string: ("--output-separator", string),
    ...
    "separator": lambda string: ("--separator", string),
    ...
    "single_quoted": lambda enable: _simple_option("--single-quoted", enable),
